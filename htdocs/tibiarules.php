...
$main_content .= '1.Regras[IMPORTANTE]
a) Nosso servidor como qualquer outro Open Tibia Server, foi desenvolvido inteiramente utilizando software Open Source.
b) Nos nao garantimos o uptime do servidor, continuidade do servico, ou que o jogo esteja livres de erros.
c) Em hipotese alguma devolveremos itens ou dias de premium perdidos, seja por erro do servidor ou por erro do jogador.
d) Nosso servidor nao tem fins lucrativos, todo o lucro ganho e convertido para manter o servidor o melhor possivel para os players.
e) Nos nao vendemos nada em nosso site. Os pagamentos feitos sao doacoes para o servidor ajudar a se manter online cada vez melhor.
f) Todas as regras do servidor sao aplicadas igualmente a todos, indiferente de ser ou nao um doador.
g) Nos nao nos responsabilizaremos pela perca de senha e RKs ja que e de sua responsabilidade a seguranca desses dados inclusive no cadastramento de um e-mail verdadeiro para recuperacao de sua conta. (Ja investimos na seguranca do servidor)
